...
class EdgeboxHandler:
    __specificConfigReader: SpecificConfigReader
    __parameterService: ParameterService
    def __init__(self):
    ...
    def read_configs(self):
        ...
        appconfigs.write_to_db= self.__specificConfigReader.get_write_to_db()
        return appconfigs
    ...
    def write_parameter(self, address: str, value, type: str):
        self.__parameterService.write_parameter(address, f"{value}", object_type=type)
